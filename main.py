...
def get_prediction(features):
  ...
  # use the project_id and model_name specified above to create parent path
  parent = 'project/%s/models/%s' % (project, model_name)
  # This is where the magic happens: get the prediction with our model and input_data
